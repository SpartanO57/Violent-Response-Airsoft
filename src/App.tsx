...
import { Header, Container, Grid, Segment, Menu, MenuMenuProps } from "semantic-ui-react";
...
class App extends Component<{}, State> {
  public state: State = {
    ...
    activeItemIndex: _findIndex(NavigationMenuData, { href: location.pathname }),
  }
      ...
      <Container>
        <Router>
          <Container>
              ...
              <Menu activeIndex={this.state.activeItemIndex} items={this.state.navItems} />
